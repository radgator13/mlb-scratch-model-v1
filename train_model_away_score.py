...
print(f"✅ Away score model R²: {score:.2%}")

# === Save ===
os.makedirs("models", exist_ok=True)
joblib.dump(model, "models/model_away_score.pkl")
joblib.dump(features, "models/trained_features_away_score.pkl")
print("💾 Saved model_away_score.pkl and feature list")
